    ...
    <main className="relative z-0 min-h-screen bg-[#080808]">
      ...
      <section className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4">
        <div className="max-w-md mx-auto p-8 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm">
          <h2 className="text-3xl font-bold text-white mb-2 text-center">Sign In or Sign Up</h2>
          <p className="text-gray-400 text-center mb-6">Continue with your Google account to login or create a new account</p>
